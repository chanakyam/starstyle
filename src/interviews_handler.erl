...
welcome(Req, State) ->
	...
	Url = "http://api.contentapi.ws/videos?channel=movies&limit=1&skip=10&format=long",
	...
	{ok, Body} = interviews_dtl:render([{<<"videoParam">>,Params},{<<"latestvideos">>,LatestVideoParams},{<<"newsParam">>,ParamsNews},{<<"videos">>,VideoParams}]),
    {Body, Req2, State}.
